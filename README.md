...
Then ask Codex (or your compatible AI assistant): **“Use $infinite-pokemon to set up and start the game for me.”** The entry skill clones any missing files, checks prerequisites, installs dependencies, builds, and launches the game.
...
[Play the browser demo](https://infinite-pokemon-blond.vercel.app/game/) · [Run from source](#run-on-your-computer) · [Explore the skills](#download-the-skills)
...
| Explore a persistent world | Battle and collect companions |
| --- | --- |
| ![Exploring the overworld in Infinite Pokémon](game/assets/showcase/exploration.png) | ![A turn-based battle in Infinite Pokémon](game/assets/showcase/battle.png) |

| Visit furnished interiors | Return to a world that remembers |
| --- | --- |
| ![Inside Professor Fern's laboratory](game/assets/showcase/interior.png) | ![Persistent places shown on the town map](game/assets/showcase/continuity.png) |

The no-install browser demo includes five prepared areas, battles, catching, interiors, and local autosave. Full play connects the local game to Codex so the world can keep growing. Multiplayer lets friends share the host's world while only the host supplies the generation allowance.
...
The setup skill and all three generation skills are published in these registries:

| Source | Quick-start skill | All four skills |
| --- | --- | --- |
| **skills.sh** | [infinite-pokemon](https://skills.sh/shellishack/infinite-pokemon/infinite-pokemon) | [region](https://skills.sh/shellishack/infinite-pokemon/infinite-pokemon-region) · [NPC](https://skills.sh/shellishack/infinite-pokemon/infinite-pokemon-npc) · [interior](https://skills.sh/shellishack/infinite-pokemon/infinite-pokemon-interior) |
| **ClawHub** | [Infinite Pokémon Quick Start](https://clawhub.ai/shellishack/skills/infinite-pokemon) | [region](https://clawhub.ai/shellishack/skills/infinite-pokemon-region) · [NPC](https://clawhub.ai/shellishack/skills/infinite-pokemon-npc) · [interior](https://clawhub.ai/shellishack/skills/infinite-pokemon-interior) |
| **skills.re** | [infinite-pokemon](https://skills.re/skills/Shellishack/infinite-pokemon/infinite-pokemon) | [region](https://skills.re/skills/Shellishack/infinite-pokemon/infinite-pokemon-region) · [NPC](https://skills.re/skills/Shellishack/infinite-pokemon/infinite-pokemon-npc) · [interior](https://skills.re/skills/Shellishack/infinite-pokemon/infinite-pokemon-interior) |
| **GitHub** | [source folder](skills/infinite-pokemon/SKILL.md) | [v0.2.0 ZIP downloads](https://github.com/Shellishack/infinite-pokemon/releases/tag/skills-v0.2.0) |

[SkillsMP](https://skillsmp.com/search?q=infinite-pokemon) was also submitted through its documented GitHub-topic indexing route, but no listing is visible yet. It is not currently a download source. See the [publication status and license notes](docs/SKILL-DISTRIBUTION.md).
